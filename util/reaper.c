...
/* 保留帳號期限 -- 學期中 */
#define DAY_NEWUSR	30	/* 登入不超過三次的使用者保留 7 天 */
#define DAY_FORFUN	180	/* 未完成身分認證的使用者保留 120 天 */
#define DAY_OCCUPY	720	/* 已完成身分認證的使用者保留 120 天 */

/* 保留帳號期限 -- 暑假 */
#define VAC_NEWUSR	30	/* 登入不超過三次的使用者保留 7 天 */
#define VAC_FORFUN	180	/* 未完成身分認證的使用者保留 180 天 */
#define VAC_OCCUPY	720	/* 已完成身分認證的使用者保留 180 天 */
