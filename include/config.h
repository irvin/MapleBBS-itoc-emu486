...
#define SCHOOLNAME	"交大鐵道會"		/* 組織名稱 */
#define BBSNAME		"內灣新小月台"		/* 中文站名 */
#define BBSNAME2	"EMU486"		/* 英文站名 */
#define SYSOPNICK	"內灣站長"		/* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"	/* 身分認證函 token */

#define MYIPADDR	"140.113.172.121"	/* IP address */
#define MYHOSTNAME	"bbs.emu486.net"	/* 網路地址 FQDN */
...
#undef	HAVE_DETECT_CROSSPOST	/* cross-post 自動偵測 */
...
#ifdef HAVE_COSIGN
#define	SYSOP_START_COSIGN	/* itoc.030613: 新板連署要先經站長審核才能開始 */
#endif
...
#  undef  HAVE_BUY		/* itoc.010716: 提供購買權限 */
...
#define NOTE_DUE	3650		/* 留言板保留時間(天) */
...
#define MARK_DUE        1800		/* 標記保存之信件保留時間(天) */
#define MAIL_DUE        6000		/* 一般信件保留時間(天) */
#define FILE_DUE        3000		/* 其他檔案保留時間(天) */
#endif

/* newbrd.c 看板連署 */

#ifdef HAVE_COSIGN
#define NBRD_NUM_BRD	14		/* 開板需要連署人數 */
...
#ifdef TIME_KICKER
#define IDLE_TIMEOUT	60		/* visio.c bguard.c 發呆過久自動簽退(分) */
